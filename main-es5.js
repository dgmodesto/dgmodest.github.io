...
var CalculadoraRoutingComponent = /** @class */ (function () {
    function CalculadoraRoutingComponent() {
    }
    ...
    return CalculadoraRoutingComponent;
}());
...
var CalculadoraRoutingModules = /** @class */ (function () {
    function CalculadoraRoutingModules() {
    }
    ...
    return CalculadoraRoutingModules;
}());
...
var CalculadoraComponent = /** @class */ (function () {
    ...
    CalculadoraComponent.ctorParameters = function () { return [
...
var ConversaoResponse = /** @class */ (function () {
    function ConversaoResponse(base, date, rates) {
        this.base = base;
        this.date = date;
        this.rates = rates;
    }
    ConversaoResponse.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: undefined }
    ]; };
...
var Conversao = /** @class */ (function () {
    function Conversao(moedaDe, moedaPara, valor) {
        this.moedaDe = moedaDe;
        this.moedaPara = moedaPara;
        this.valor = valor;
    }
    Conversao.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: Number }
    ]; };
...
var Moeda = /** @class */ (function () {
    function Moeda(sigla, descricao) {
        this.sigla = sigla;
        this.descricao = descricao;
    }
    Moeda.ctorParameters = function () { return [
        { type: String },
        { type: String }
    ]; };
    return Moeda;
...
var ConversorRoutingModule = /** @class */ (function () {
    function ConversorRoutingModule() {
    }
...
var ConversorComponent = /** @class */ (function () {
    function ConversorComponent(moedaService, conversorService) {
        this.moedaService = moedaService;
        this.conversorService = conversorService;
    }
    ConversorComponent.prototype.ngOnInit = function () {
     ...
     * @return void
     */
    ConversorComponent.prototype.init = function () {
     ...
     */
    ConversorComponent.prototype.converter = function () {
        var _this = this;
        if (this.conversaoForm.form.valid) {
            // alert('Convertendo: ' + JSON.stringify(this.conversao));
            this.conversorService
                .converter(this.conversao)
                .subscribe(function (response) { return (_this.conversaoResponse = response); }, function (error) { return (_this.possuiErro = true); });
        }
    };
    ConversorComponent.ctorParameters = function () { return [
...
var ConversorRoutingComponent = /** @class */ (function () {
    function ConversorRoutingComponent() {
    }
    ...
    return ConversorRoutingComponent;
}());
...
var ConversorModule = /** @class */ (function () {
...
var NumeroDirective = /** @class */ (function () {
    function NumeroDirective(el) {
        this.el = el;
    }
    NumeroDirective_1 = NumeroDirective;
    /**
     * Implementa evetnod okeyup para o elemento da diretiva
     * @param $event
     */
    NumeroDirective.prototype.onkeyup = function ($event) {
        var valor = $event.target.value;
        var posDecimais = valor.indexOf('.');
     ...
     * @params valor
     */
    NumeroDirective.prototype.registerOnChange = function (fn) {
        this.onChange = fn;
    };
    /**
     ...
     * @params fn
     */
    NumeroDirective.prototype.registerOnTouched = function (fn) {
        this.onTouched = fn;
    };
    /**
     ...
     * @params value
     */
    NumeroDirective.prototype.writeValue = function (value) {
        this.el.nativeElement.value = value;
    };
    NumeroDirective.prototype.setDisabledState = function (isDisabled) {
        throw new Error('Method not implemented.');
    };
    var NumeroDirective_1;
    NumeroDirective.ctorParameters = function () { return [
...
var DataBrPipe = /** @class */ (function () {
     ...
     */
    DataBrPipe.prototype.transform = function (dataEn) {
        if (!dataEn) {
            return '';
        }
        var dataArr = dataEn.split('-');
        if (dataArr.length !== 3) {
            return dataEn;
        }
...
var ConversorService = /** @class */ (function () {
    function ConversorService(http) {
        this.http = http;
     ...
     */
    ConversorService.prototype.converter = function (conversao) {
        // Na linha abaixo altere a '?' por '&'
        var params = "&base=" + conversao.moedaDe + "&symbols=" + conversao.moedaPara;
     ...
     * @return number
     */
    ConversorService.prototype.cotacaoPara = function (conversaoResponse, conversao) {
     ...
     * @return string
     */
    ConversorService.prototype.cotacaoDe = function (conversaoResponse, conversao) {
        if (conversaoResponse === undefined) {
            return '0';
        }
     ...
     * @return string
     */
    ConversorService.prototype.dataCotacao = function (conversaoResponse) {
        if (conversaoResponse === undefined) {
            return '';
        }
        return conversaoResponse.date;
    };
    ConversorService.ctorParameters = function () { return [
...
var MoedaService = /** @class */ (function () {
    function MoedaService() {
        this.moedasObj = [
            //http://fixer.io
    ...
    MoedaService.prototype.listarTodas = function () {
        var e_1, _a;
        if (this.moedas) {
            return this.moedas;
        }
        this.moedas = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.moedasObj), _c = _b.next(); !_c.done; _c = _b.next()) {
                var moedaObj = _c.value;
                var moeda = new _Models__WEBPACK_IMPORTED_MODULE_2__["Moeda"]();
...
var ModalCotacaoComponent = /** @class */ (function () {
    function ModalCotacaoComponent(conversorService) {
        this.conversorService = conversorService;
    ...
    ModalCotacaoComponent.prototype.ngOnInit = function () { };
    ModalCotacaoComponent.prototype.novaConsulta = function () {
        this.confirm.emit();
    };
    Object.defineProperty(ModalCotacaoComponent.prototype, "valorConvertido", {
        get: function () {
    ...
    Object.defineProperty(ModalCotacaoComponent.prototype, "cotacaoPara", {
        get: function () {
    ...
    Object.defineProperty(ModalCotacaoComponent.prototype, "cotacaoDe", {
        get: function () {
    ...
    Object.defineProperty(ModalCotacaoComponent.prototype, "dataCotacao", {
        get: function () {
    ...
    ModalCotacaoComponent.ctorParameters = function () { return [
...
var DadosService = /** @class */ (function () {
    ...
    DadosService.prototype.obterDados = function () {
        var _this = this;
        return new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observable) {
            observable.next(_this.dados);
            observable.complete();
        });
    };
...
var DashboardRoutingComponent = /** @class */ (function () {
    function DashboardRoutingComponent() {
    }
    ...
    return DashboardRoutingComponent;
}());
...
var DashboardComponent = /** @class */ (function () {
     ...
     * @return void
     */
    DashboardComponent.prototype.exibirPieChart = function () {
        var el = document.getElementById('pie_chart');
    ...
    DashboardComponent.prototype.exibir3dPieChart = function () {
        var el = document.getElementById('3d_pie_chart');
        var chart = new google.visualization.PieChart(el);
     ...
     * @return void
     */
    DashboardComponent.prototype.exibirBarChart = function () {
        var el = document.getElementById('bar_chart');
     ...
     * @return void
     */
    DashboardComponent.prototype.exibirDonutChart = function () {
        var el = document.getElementById('donut_chart');
        var chart = new google.visualization.PieChart(el);
        var opcoes = this.ObterOpcoes();
        opcoes.pieHole = 0.4;
        chart.draw(this.obterDataTable(), opcoes);
     ...
     * @return void
     */
    DashboardComponent.prototype.exibirColumnChart = function () {
        var el = document.getElementById('column_chart');
...
var JogoDaVelhaRoutingComponent = /** @class */ (function () {
    function JogoDaVelhaRoutingComponent() {
    }
    ...
    return JogoDaVelhaRoutingComponent;
}());
...
var JogoDaVelhaRoutingModule = /** @class */ (function () {
    function JogoDaVelhaRoutingModule() {
    }
    ...
    return JogoDaVelhaRoutingModule;
}());
...
var JogoDaVelhaComponent = /** @class */ (function () {
    function JogoDaVelhaComponent(jogoDaVelhaService) {
        this.jogoDaVelhaService = jogoDaVelhaService;
    }
    JogoDaVelhaComponent.prototype.ngOnInit = function () {
        this.jogoDaVelhaService.inicializar();
    };
    Object.defineProperty(JogoDaVelhaComponent.prototype, "showInicio", {
        /**
    ...
    Object.defineProperty(JogoDaVelhaComponent.prototype, "showTabuleiro", {
        /**
    ...
    Object.defineProperty(JogoDaVelhaComponent.prototype, "showFinal", {
        /**
     ...
     * @return void
     */
    JogoDaVelhaComponent.prototype.iniciarJogo = function ($event) {
     ...
     * @return void
     */
    JogoDaVelhaComponent.prototype.jogar = function (posX, posY) {
     ...
     * @return boolean
     */
    JogoDaVelhaComponent.prototype.exibirX = function (posX, posY) {
     ...
     * @return boolean
     */
    JogoDaVelhaComponent.prototype.exibirO = function (posX, posY) {
     ...
     * @return boolean
     */
    JogoDaVelhaComponent.prototype.exibirVitoria = function (posX, posY) {
        return this.jogoDaVelhaService.exibirVitoria(posX, posY);
    };
    Object.defineProperty(JogoDaVelhaComponent.prototype, "jogador", {
        /**
     ...
     * @return void
     */
    JogoDaVelhaComponent.prototype.novoJogo = function ($event) {
        $event.preventDefault();
        this.jogoDaVelhaService.novoJogo();
    };
    JogoDaVelhaComponent.ctorParameters = function () { return [
...
var JogoDaVelhaModule = /** @class */ (function () {
    function JogoDaVelhaModule() {
    }
...
var JogoDaVelhaService = /** @class */ (function () {
    function JogoDaVelhaService() {
        this.TAM_TAB = 3;
        this.X = 1;
        this.O = 2;
        this.VAZIO = 0;
     ...
     * @return void
     */
    JogoDaVelhaService.prototype.inicializar = function () {
     ...
     * @return void
     */
    JogoDaVelhaService.prototype.inicializarTabuleiro = function () {
        this.tabuleiro = [this.TAM_TAB];
        for (var i = 0; i < this.TAM_TAB; i++) {
            this.tabuleiro[i] = [this.VAZIO, this.VAZIO, this.VAZIO];
        }
    };
    Object.defineProperty(JogoDaVelhaService.prototype, "showInicio", {
        /**
    ...
    Object.defineProperty(JogoDaVelhaService.prototype, "showTabuleiro", {
        /**
         * Retorna se o tabuleiro deve ser exibido
         * @return boolean
         */
    ...
    Object.defineProperty(JogoDaVelhaService.prototype, "showFinal", {
        /**
         * Retorna se a tela de fim de jogo deve ser exibida
         * @return boolean
         */
    ...
    Object.defineProperty(JogoDaVelhaService.prototype, "jogador", {
        /**
     ...
     * @return void
     */
    JogoDaVelhaService.prototype.iniciarJogo = function () {
     ...
     * @return void
     */
    JogoDaVelhaService.prototype.jogar = function (posX, posY) {
        debugger;
        // jogada invalida
    ...
    JogoDaVelhaService.prototype.fimJogo = function (linha, coluna, tabulerio, jogador) {
        var fim = false;
        // valida a linha
     ...
     */
    JogoDaVelhaService.prototype.cpuJogar = function () {
        // verifica jogada de vitória
        var jogada = this.obterJogada(this.O);
        if (jogada.length <= 0) {
        ...
        if (jogada.length <= 0) {
            ...
            var k = Math.floor(Math.random() * (jogadas.length - 1));
     ...
     * @return nomber[]
     */
    JogoDaVelhaService.prototype.obterJogada = function (jogador) {
        var tab = this.tabuleiro;
     ...
     * @return boolean
     */
    JogoDaVelhaService.prototype.exibirX = function (posX, posY) {
     ...
     * @return boolean
     */
    JogoDaVelhaService.prototype.exibirO = function (posX, posY) {
     ...
     * @return boolean
     */
    JogoDaVelhaService.prototype.exibirVitoria = function (posX, posY) {
        var e_1, _a;
        var exibirVitoria = false;
        if (!this.vitoria) {
            return exibirVitoria;
        }
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.vitoria), _c = _b.next(); !_c.done; _c = _b.next()) {
                var pos = _c.value;
     ...
     * @return void
     */
    JogoDaVelhaService.prototype.novoJogo = function () {
        this.inicializar();
        this._showFinal = false;
        this._showInicio = false;
        this._showTabuleiro = true;
...
var CadastrarTarefasComponent = /** @class */ (function () {
    function CadastrarTarefasComponent(tarefaService, router) {
        this.tarefaService = tarefaService;
        this.router = router;
    }
    CadastrarTarefasComponent.prototype.ngOnInit = function () {
        this.tarefa = new _shared_tarefa_model__WEBPACK_IMPORTED_MODULE_2__["Tarefa"]();
    };
    CadastrarTarefasComponent.prototype.cadastrar = function () {
        if (this.formTarefa.form.valid) {
            this.tarefaService.cadastrar(this.tarefa);
            this.router.navigate(['/tarefas']);
        }
    };
    CadastrarTarefasComponent.ctorParameters = function () { return [
    ...
    return CadastrarTarefasComponent;
}());
...
var EditarTarefaComponent = /** @class */ (function () {
    function EditarTarefaComponent(tarefaService, route, router) {
        this.tarefaService = tarefaService;
        this.route = route;
        this.router = router;
    }
    ...
    EditarTarefaComponent.prototype.atualizar = function () {
        if (this.formTarefa.form.valid) {
            this.tarefaService.atualizar(this.tarefa);
            this.router.navigate(["/tarefas"]);
        }
    };
    EditarTarefaComponent.ctorParameters = function () { return [
...
/*!**********************************!*\
  !*** ./src/app/tarefas/index.js ***!
  \**********************************/
/*! exports provided: TarefasModule, TarefasRoutes, TarefasRoutingModule, Tarefa, TarefaService, TarefaConcluidaDirective, ListarTarefaComponent, CadastrarTarefasComponent, EditarTarefaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ListarTarefaComponent = /** @class */ (function () {
    function ListarTarefaComponent(tarefaService) {
        this.tarefaService = tarefaService;
    }
    ...
    ListarTarefaComponent.prototype.listarTodos = function () {
        return this.tarefaService.listarTodos();
    };
    ListarTarefaComponent.prototype.remover = function ($event, tarefa) {
        $event.preventDefault();
    ...
    ListarTarefaComponent.prototype.alterarStatus = function (tarefa) {
        if (confirm("Deseja alterar status da tarefa: " + tarefa.nome + "?")) {
            this.tarefaService.alterarStatus(tarefa.id);
            this.tarefas = this.tarefaService.listarTodos();
        }
    };
    ListarTarefaComponent.ctorParameters = function () { return [
        { type: _shared_tarefa_service__WEBPACK_IMPORTED_MODULE_2__["TarefaService"] }
    ]; };
...
var TarefaConcluidaDirective = /** @class */ (function () {
    function TarefaConcluidaDirective(el) {
        this.el = el;
    }
    TarefaConcluidaDirective.prototype.ngOnInit = function () {
        if (this.tarefaConcluida) {
            this.el.nativeElement.style.textDecoration = "line-through";
        }
    };
    TarefaConcluidaDirective.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TarefaConcluidaDirective;
}());
...
var TarefaService = /** @class */ (function () {
    ...
    TarefaService.prototype.listarTodos = function () {
        var tarefas = localStorage.tarefas;
        return tarefas ? JSON.parse(tarefas) : [];
    };
    TarefaService.prototype.cadastrar = function (tarefa) {
    ...
    TarefaService.prototype.buscarPorId = function (id) {
        var tarefas = this.listarTodos();
        return tarefas.find(function (tarefa) { return tarefa.id === id; });
    };
    TarefaService.prototype.atualizar = function (tarefa) {
        var tarefas = this.listarTodos();
        tarefas.forEach(function (obj, index, objs) {
            if (tarefa.id === obj.id) {
                objs[index] = tarefa;
            }
        });
    ...
    TarefaService.prototype.alterarStatus = function (id) {
        var tarefas = this.listarTodos();
        tarefas.forEach(function (obj, index, objs) {
            if (id === obj.id) {
...
var TarefasRoutingComponent = /** @class */ (function () {
    function TarefasRoutingComponent() {
    }
    ...
    return TarefasRoutingComponent;
}());
...
var TarefasRoutingModule = /** @class */ (function () {
    function TarefasRoutingModule() {
    }
